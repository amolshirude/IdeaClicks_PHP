...
<div class="box" style="margin-left: auto; margin-right: auto; padding:5px 10px 5px 10px">
    <div id="view_ideas" class="view-idea-container">
        <form id="on_tile_click_form" action="../Ideas/like_dislike_comment" method="post">
            ...
            <br>
            <?php endforeach; }else{echo 'No Idea for selected group';}?>
        </form>
    </div>
</div>
<script type="text/javascript">
    $(document).ready(function () {
        $("#selected_category").change(function () {
            ...
            jQuery.post('filterIdeasByGroupWithCategory', {group_id: selectedGroup ,category_id: selectedCategory}, function(data) {
