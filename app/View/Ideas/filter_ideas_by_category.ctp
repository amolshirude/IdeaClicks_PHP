...
<div id="view_ideas" class="view-idea-container">
    <form id="on_tile_click_form" action="../Ideas/like_dislike_comment" method="post">
        ...
        <div class="idea-container">
            <label >Title:</label>
            <a class="idea-title" href="#" onclick="onClcikOnIdeaTitle('<?php echo $row['I']['nbr_submitter_id']?>')"><?php echo $row['I']['txt_title']; ?></a>
            <br><br>
            ...
            <div id="like_dislike">
                <img id="like" src="../app/webroot/img/thumbs-up.png" onclick="onClickonLikeIdea('<?php echo $row['I']['nbr_submitter_id']; ?>','<?php echo $row['I']['nbr_like_count']; ?>','<?php echo $row['I']['nbr_dislike_count']; ?>')"/>
                <?php echo $row['I']['nbr_like_count']; ?>
                <img id="dislike" src="../app/webroot/img/thumbs-down.png" onclick="onClickonDislikeIdea('<?php echo $row['I']['nbr_submitter_id']; ?>','<?php echo $row['I']['nbr_like_count']; ?>','<?php echo $row['I']['nbr_dislike_count']; ?>')"/>
