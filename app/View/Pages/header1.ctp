        ...
        <table  width="100%" style="background-color:lightslategray;" >
            <tr  align="right">
                ...
                <?php if($userInfo['User']['txt_image_path']!=''){
                        ...
                        $dir = $this->webroot.'userimages/'.$file;?> <img style="height:30px;width:30px;border-radius: 50%;" name="prof_image" src="<?php echo $dir;?>" />
                        <?php }?>
               <b><?php echo CakeSession::read('session_name');?></b></td>
               </tr>
            <tr  align="right"/>
